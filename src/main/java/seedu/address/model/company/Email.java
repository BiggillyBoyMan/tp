...
/**
 * Represents an email address in an internship application in BizBook.
...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain.tld "
            ...
            + "characters.\n"
            + "2. This is followed by a '@' and then a domain name (e.g., gmail, company, university).\n"
            + "3. The domain must be followed by at least one period and a top-level domain (e.g., .com, .edu, .org).\n"
            + "The domain must:\n"
            + "    - have at least one subdomain and one TLD (e.g., user@gmail.com, user@company.edu)\n"
            + "    - have each domain label start and end with alphanumeric characters\n"
            + "    - have each domain label consist of alphanumeric characters, separated only by hyphens, if any\n"
            + "    - end with a TLD at least 2 characters long";
